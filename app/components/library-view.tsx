...
export function LibraryView({ collections, onSelectCollection, onCreateNew, className }: LibraryViewProps) {
  return (
    <div className={cn("bg-black text-white min-h-screen px-6 py-8", className)}>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-serif text-white mb-2">Your Collection</h1>
